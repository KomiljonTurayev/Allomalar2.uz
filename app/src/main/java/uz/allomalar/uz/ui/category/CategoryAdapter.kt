...
import kotlinx.android.synthetic.main.item_sub_horizontal.view.*
import uz.allomalar.uz.R
import uz.allomalar.uz.network.dto.MockData

class CategoryAdapter(val oldCost: Boolean = false, val discount: Boolean = false): RecyclerView.Adapter<CategoryAdapter.ViewHolder>() {
...
//                    Toast.makeText(itemView.context, "imgEmpty", Toast.LENGTH_SHORT).show()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_sub_horizontal, parent, false)
